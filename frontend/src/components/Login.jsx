      ...
      <div className="p-8 border shadow-2xl glass-dark rounded-2xl border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center w-full px-6 py-4 space-x-2 font-semibold text-white transition-all duration-300 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl hover:from-blue-600 hover:to-purple-600 disabled:opacity-50"
          >
            {loading ? (
